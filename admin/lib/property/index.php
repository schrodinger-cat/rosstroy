...
$oAdminFormEntityMenus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('lib_property.lib_property_parametr'))
		->add(
			Admin_Form_Entity::factory('Menu')
				->name(Core::_('lib_property.lib_property_add'))
				->img('/admin/images/script_code_red_gear_add.gif')
				->href(
