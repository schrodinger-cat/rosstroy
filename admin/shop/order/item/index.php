...
$oOrder = Core_Entity::factory('Shop_Order', $shop_order_id);
...
$oAdmin_Form_Controller
	...
	->title($sFormTitle = Core::_('Shop_Order_Item.show_order_items_title', $oOrder->invoice))
...
$oAdmin_Form_Entity_Menus->add(
	Admin_Form_Entity::factory('Menu')
		->name(Core::_('Shop_Order_Item.links_items'))
		->add(
			Admin_Form_Entity::factory('Menu')
...
$oAdmin_Form_Entity_Breadcrumbs->add(
	Admin_Form_Entity::factory('Breadcrumb')
		...
		(
			$oAdmin_Form_Controller->getAdminLoadHref
			(
				$sShopOrderFormPath = '/admin/shop/order/index.php',
				NULL,
				NULL,
