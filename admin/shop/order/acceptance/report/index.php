...
$sPageTitle = Core::_("Shop_Order.acceptance_report_akt", $oShop_Order->acceptance_report,Core_Date::sql2date($oShop_Order->datetime)) . Core::_("Shop_Order.acceptance_report_year");
