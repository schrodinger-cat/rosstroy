...
function preinit() {
	...
	// -- add Hostmake
	var external_link_list;
	if (external_link_list = tinyMCEPopup.getParam("external_link_list"))
	{
		document.write('<sc'+'ript language="javascript" type="text/javascript">' + external_link_list + '</sc'+'ript>');
	}
}
