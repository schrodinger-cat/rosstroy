					...
					<xsl:choose>
						<xsl:when test="/informationsystem/siteuser_id > 0">
							...
							<span class="inner_thumbs">
								<a onclick="return $.sendVote({@id}, 1, 'informationsystem_item')" href="{/informationsystem/url}?id={@id}&amp;vote=1&amp;entity_type=informationsystem_item" alt="Нравится"></a>
								<span class="rate" id="informationsystem_item_rate_{@id}"><xsl:value-of select="rate" /></span>
								<a onclick="return $.sendVote({@id}, 0, 'informationsystem_item')" href="{/informationsystem/url}?id={@id}&amp;vote=0&amp;entity_type=informationsystem_item" alt="Не нравится"></a>
							</span>
